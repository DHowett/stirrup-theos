...
_THEOS_DEB_HAS_STIRRUP_SIGNIMAGE = $(call __executable,imgutil)
...
internal-package::
	$(ECHO_NOTHING)imgutil sign -key=$(PACKAGE_SIGNING_KEY) -cert=$(PACKAGE_SIGNING_CERT) -mime=application/x-opkg -out="$(_THEOS_SIGNED_PACKAGE_FILENAME)" "$(_THEOS_DEB_PACKAGE_FILENAME)"$(ECHO_END)
